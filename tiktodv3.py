...
if auto == 1 or auto == 2 or auto == 3 or auto == 4:
    vidUrl = input("TikTok video URL: https://www.tiktok.com/@abdallahomran/video/7115833239306128645?is_from_webapp=1&sender_device=pc&web_id=7075189428894057989 ")
